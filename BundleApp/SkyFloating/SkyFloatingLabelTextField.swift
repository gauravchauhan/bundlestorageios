...
//            self.attributedPlaceholder = NSAttributedString(string: placeholder, attributes: [((((kCTForegroundColorAttributeName as NSAttributedStringKey) as NSAttributedStringKey) as NSAttributedStringKey) as NSAttributedStringKey) as NSAttributedStringKey:placeholderColor,
    ...
    */
    ...
    fileprivate func createTitleLabel() {
        ...
        if UIDevice.current.userInterfaceIdiom == .pad{
            ...
            titleLabel.font = UIFont(name: Constants.fonts.ProximaNova_Regular, size: 14)
