...
extension UIViewController {
    ...
    @IBAction func presentSideMenuController() {
        
        sideMenuViewController?._presentSideMenuController()
    }
}
...
class SSASideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    convenience init(contentViewController: UIViewController, sideMenuController: UIViewController) {
        self.init()
        self.contentViewController = contentViewController
        self.sideMenuController = sideMenuController
    }
    
    convenience init(contentViewController: UIViewController, leftMenuViewController: UIViewController, sideMenuController: UIViewController) {
        self.init()
        self.contentViewController = contentViewController
        self.leftMenuViewController = leftMenuViewController
        self.sideMenuController = sideMenuController
    ...
    func _presentSideMenuController() {
        presentMenuViewContainerWithMenuViewController(sideMenuController)
    ...
    fileprivate func showSideMenuController() {
        
        if let viewController = sideMenuController {
    ...
    fileprivate func animateMenuViewControllerCompletion(_ side: SSASideMenuSide, menuViewController: UIViewController) {
        ...
        case .right:
            ...
            sideMenuController?.endAppearanceTransition()
        }
    ...
    fileprivate func hideMenuViewController(_ animated: Bool) {
        ...
        let visibleMenuViewController: UIViewController? = isRightMenuVisible ? sideMenuController : leftMenuViewController
        
        visibleMenuViewController?.beginAppearanceTransition(true, animated: true)
        
        if isRightMenuVisible, let viewController = sideMenuController {
        ...
        let completionClosure: () -> () =  {[unowned self] () -> () in
            ...
            if isRightMenuVisible, let viewController = self.sideMenuController {
    ...
    override func awakeFromNib() {
        ...
        if iOS8 {
            ...
            if let rghtViewStoryboardID = rightMenuViewStoryboardID {
                sideMenuController = storyboard?.instantiateViewController(withIdentifier: rghtViewStoryboardID)
            }
        }
    }
    ...
    override func viewDidLoad() {
        ...
        setupViewController(menuViewContainer, targetViewController: sideMenuController)
    ...
    override var preferredStatusBarUpdateAnimation: UIStatusBarAnimation{
        ...
        if let cntViewController = contentViewController, let rghtMenuViewController = sideMenuController {
    ...
    @objc func panGestureRecognized(_ recognizer: UIPanGestureRecognizer) {
        ...
        if recognizer.state == .changed {
            ...
            if !didNotifyDelegate {
                ...
                if point.x < 0 && !visible, let viewController = sideMenuController {
                    delegate?.sideMenuWillShowMenuViewController?(self, menuViewController: viewController)
                }
            ...
            sideMenuController?.view.isHidden = contentViewContainer.frame.origin.x > 0
            ...
            if  leftMenuViewController == nil && contentViewContainer.frame.origin.x > 0 {
                ...
                visible = false
                leftMenuVisible = false
            } else if self.sideMenuController == nil && contentViewContainer.frame.origin.x < 0 {
                contentViewContainer.transform = CGAffineTransform.identity
                contentViewContainer.frame = view.bounds
                visible = false
                rightMenuVisible = false
        ...
        if recognizer.state == .ended {
            ...
            if panMinimumOpenThreshold > 0 &&
                ...
                if contentViewContainer.frame.origin.x < 20 &&  sideMenuController != nil{
                    showSideMenuController()
                } else {
                    hideMenuViewController()
                }
