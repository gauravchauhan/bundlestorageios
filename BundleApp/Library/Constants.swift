...
struct Constants {
    ...
    struct AppUrls{
        ...
        static let webViewURLForLinden = "https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=\(Constants.AppUrls.linkdenClient_id)&redirect_uri=http://testthem.com/redirect&state=DCEeFWf45A53sdfKef424sw&scope=r_liteprofile%20r_emailaddress%20w_member_social"
